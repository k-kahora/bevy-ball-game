...
pub fn update_enemy_direction(
    ...
    let enemy_half_size: f32 = ENEMY_SIZE / 2.0;
    let x_min: f32 = 0.0 + enemy_half_size;
    let x_max: f32 = window.width() - enemy_half_size;
    let y_min: f32 = 0.0 + enemy_half_size;
    let y_max: f32 = window.height() - enemy_half_size;
...
)
{
    for mut enemy in enemy_query.iter_mut() {
	    ...
	    let enemy_half_size: f32 = PLAYER_SIZE / 2.0;
